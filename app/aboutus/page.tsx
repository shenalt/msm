...
export default function AboutUs(){
    return(
        <div className="z-10 w-full flex flex-col items-center">
            ...
            <div className="flex flex-col my-8 mx-8 w-full 2xl:w-3/4 m-auto border-t border-b border-t-msmBlue border-b-msmRed hover:text-msmRed hover:border-t-msmRed transition-all duration-500">
                {/* <div className="w-3/4 m-auto border-t border-b border-t-msmBlue border-b-msmRed"> */}
                    ...
                    <h1 className="m-4 text-xl">
                        Our flagship podcast, My First Dungeon, features host Brian Flaherty guiding game masters and players through games new and old as we learn together to make them as fun as possible for all 
            ...
            <div className="flex flex-col 2xl:flex-row w-full 2xl:w-3/4 my-8 p-8 border-b border-b-msmBlue">
                ...
                <div>
                    ...
                    <h3 className="text-sm text-center text-msmRed">(he/him)</h3>
                    <p className="my-8 mx-2 2xl:mx-8 text-3xl hover:text-msmRed transition-all duration-500">
            ...
            <div className="flex flex-col 2xl:flex-row w-full 2xl:w-3/4 my-8 p-8 border-b border-b-msmYellow">
                ...
                <div>
                    ...
                    <h3 className="text-sm text-center text-msmBlue">(he/him)</h3>
                    <p className="my-8 mx-2 2xl:mx-8 text-2xl hover:text-msmBlue transition-all duration-500">
            ...
            <div className="flex flex-col 2xl:flex-row w-full 2xl:w-3/4 my-8 p-8 border-b border-b-msmRed">
                ...
                <div>
                    ...
                    <h3 className="text-sm text-center text-msmYellow">(he/him)</h3>
            ...
            <div className="flex flex-col 2xl:flex-row w-full 2xl:w-3/4 my-8 p-8 border-b-[1px]">
                ...
                <div>
                    ...
                    <h3 className="text-sm text-center text-msmRed">(she/her)</h3>
                    <p className="my-8 mx-2 2xl:mx-8 text-xl hover:text-msmRed transition-all duration-500">
