    ...
    return(
        <div className="z-10 w-full flex flex-col items-center">
            <div className="flex flex-col m-8 w-full 2xl:w-3/4">
                <div className="w-3/4 m-auto border border-t-msmBlue border-b-msmRed border-r-msmYellow border-l-msmYellow">
                    <h6 className="m-4 text-base text-center"><u>WHO WE ARE</u></h6>
