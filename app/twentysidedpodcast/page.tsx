            ...
            {/* <div className="collapse w-11/12 lg:w-4/6 border rounded-box border-base-300 collapse-arrow bg-msmRed text-neutral-50">
                ...
                <div className="collapse-content">
                    ...
                    <div className="card lg:card-side card-bordered my-4">                       
                        <Image src={titanfall} alt="Escape from the R.M.S. Titanfall Logo" className="w-full lg:w-1/5 rounded-2xl" />                        
                        <div className="card-body">
                            <h2 className="card-title text-3xl my-2">Ep. 1: Setting Sail</h2> 
                            <h6 className="text-xs my-2">July 26th, 2021</h6>
                            <p className="text-lg my-2">Join Cleave Beefchief (Kevin), Meadhbh Snailbaby (Blythe), and Karis Thornbrow (Jenny) as they each find their way aboard the maiden voyage of the grandest ship ever built: the R.M.S. Titanfall.</p> 
                    ...
                    <div className="card lg:card-side card-bordered my-4">                       
                        <Image src={titanfall} alt="Escape from Titanfall Logo" className="w-full lg:w-1/5 rounded-2xl" />                        
                        <div className="card-body">
                            <h2 className="card-title text-3xl my-2">Ep. 2: The Liminal Sea</h2> 
                            <h6 className="text-xs my-2">August 2nd, 2021</h6>
                            <p className="text-lg my-2">Stowaways, shuffleboard, and smoke detectors.</p>
                            <div className="card-actions">
                                <Link href={"https://podcasts.apple.com/us/podcast/ep-1-setting-sail-r-m-s-titanfall-arc/id1578469041?i=1000530159116"} target="_blank">
                                    <button className="btn btn-primary">More Info</button>
                                </Link> 
                    ...
                    <div className="card lg:card-side card-bordered my-4">                       
                        <Image src={titanfall} alt="Escape from Titanfall Logo" className="w-full lg:w-1/5 rounded-2xl" />                        
                        <div className="card-body">
                            <h2 className="card-title text-3xl my-2">Ep. 3: Saloon Skirmish</h2> 
                            <h6 className="text-xs my-2">August 9th, 2021</h6>
                            <p className="text-lg my-2">A brawl breaks out in the second-class saloon and the ship's architect, Mertelby, is caught in the crossfire! Is it coincidence that the tortle with the answers is in the middle of a barfight or are there more sinister forces at play?</p>
                            <div className="card-actions">
                    ...
                    <div className="card lg:card-side card-bordered my-4">                       
                        <Image src={titanfall} alt="Escape from Titanfall Logo" className="w-full lg:w-1/5 rounded-2xl" />                        
                        <div className="card-body">
                            <h2 className="card-title text-3xl my-2">Ep. 4: Inquisitions</h2> 
                            <h6 className="text-xs my-2">August 16th, 2021</h6>
                            <p className="text-lg my-2">Our heroes search for answers but only find more questions. And questions can be deadly.</p>
                            <div className="card-actions">
                    ...
                    <div className="card lg:card-side card-bordered my-4">                       
                        <Image src={titanfall} alt="Escape from Titanfall Logo" className="w-full lg:w-1/5 rounded-2xl" />                        
                        <div className="card-body">
                            <h2 className="card-title text-3xl my-2">Ep. 5: Countdown to Catastrophe</h2> 
                            <h6 className="text-xs my-2">August 23rd, 2021</h6>
                            <p className="text-lg my-2">The clock is ticking as our heroes take stock of their perilous situation and wrestle with the resurrection of a long-lost evil.</p>
                            <div className="card-actions">
                    ...
                    <div className="card lg:card-side card-bordered my-4">                       
                        <Image src={titanfall} alt="Escape from Titanfall Logo" className="w-full lg:w-1/5 rounded-2xl" />                        
                        <div className="card-body">
                            <h2 className="card-title text-3xl my-2">Ep. 6: Loyalites</h2> 
                            <h6 className="text-xs my-2">August 30th, 2021</h6>
                            <p className="text-lg my-2">Our heroes decide how to deal with a newly uncovered treachery and learn that their troubles may be worse than they thought.</p>
                            <div className="card-actions">
                    ...
                    <div className="card lg:card-side card-bordered my-4">                       
                        <Image src={titanfall} alt="Escape from Titanfall Logo" className="w-full lg:w-1/5 rounded-2xl" />                        
                        <div className="card-body">
                            <h2 className="card-title text-3xl my-2">Ep. 7: Mayday</h2> 
                            <h6 className="text-xs my-2">September 6th, 2021</h6>
                            <p className="text-lg my-2">Dangers continue to mount and our heroes begin to realize they may have even less time than they thought.</p>
                            <div className="card-actions">
                    ...
                    <div className="card lg:card-side card-bordered my-4">                       
                        <Image src={titanfall} alt="Escape from Titanfall Logo" className="w-full lg:w-1/5 rounded-2xl" />                        
                        <div className="card-body">
                            <h2 className="card-title text-3xl my-2">Ep. 8: Flight of the Bumblebee</h2> 
                            <h6 className="text-xs my-2">September 13th, 2021</h6>
                            <p className="text-lg my-2">Our heroes–along with a swarm of militant bees–continue climbing up the ship to face off with The Drowned and the fearsome monstrosity above.</p>
                            <div className="card-actions">
                    ...
                    <div className="card lg:card-side card-bordered my-4">                       
                        <Image src={titanfall} alt="Escape from Titanfall Logo" className="w-full lg:w-1/5 rounded-2xl" />                        
                        <div className="card-body">
                            <h2 className="card-title text-3xl my-2">Ep. 9: Mob Mentality</h2> 
                            <h6 className="text-xs my-2">September 27th, 2021</h6>
                            <p className="text-lg my-2">Tensions aboard the R.M.S. Titanfall reach a boiling point as a desperate mob of passengers begins to look more and more like a weapon to be wielded.</p>
                            <div className="card-actions">
                    ...
                    <div className="card lg:card-side card-bordered my-4">                       
                        <Image src={titanfall} alt="Escape from Titanfall Logo" className="w-full lg:w-1/5 rounded-2xl" />                        
                        <div className="card-body">
                            <h2 className="card-title text-3xl my-2">Ep. 10: Dead in the Water</h2> 
                            <h6 className="text-xs my-2">October 4th, 2021</h6>
                            <p className="text-lg my-2">Adrift, broken, and exhausted…<br/>
                    ...
                    <div className="card lg:card-side card-bordered my-4">                       
                        <Image src={titanfall} alt="Escape from Titanfall Logo" className="w-full lg:w-1/5 rounded-2xl" />                        
                        <div className="card-body">
                            <h2 className="card-title text-3xl my-2">Ep. 11: Abandon Ship</h2> 
                            <h6 className="text-xs my-2">October 11th, 2021</h6>
                            <p className="text-lg my-2">SEASON FINALE!!<br/>
                ...
                <div className="collapse-content"> 
                    ...
                    <div className="card lg:card-side card-bordered border-neutral-900 my-4">                       
                        ...
                        <div className="card-body">
                            ...
                            <p className="text-lg my-2">After discovering a cryptic message from a legendary figure, a new cast of characters each find their way aboard a dangerous voyage directly into The Static. But be warned, not everything is what it seems...</p> 
                            <div className="card-actions">
                    ...
                    <div className="card lg:card-side card-bordered border-neutral-900 my-4">                       
                        ...
                        <div className="card-body">
                            ...
                            <p className="text-lg my-2">Welcome to The Village.</p> 
                            <div className="card-actions">
                    ...
                    <div className="card lg:card-side card-bordered border-neutral-900 my-4">                       
                        ...
                        <div className="card-body">
                            ...
                            <p className="text-lg my-2">The crew of the Gilded Ghost discover some strange new abilities, courtesy of The Static.</p> 
                            <div className="card-actions">
                    ...
                    <div className="card lg:card-side card-bordered border-neutral-900 my-4">                       
                        ...
                        <div className="card-body">
                            ...
                            <p className="text-lg my-2">Sienni fights for his life. Yaksha relives a memory. Natasha sees a ghost.</p> 
                            <div className="card-actions">
                    ...
                    <div className="card lg:card-side card-bordered border-neutral-900 my-4">                       
                        ...
                        <div className="card-body">
                            ...
                            <p className="text-lg my-2">Natasha sees a ghost from her past. Yaksha perfects his No. 2 impression. Sienni becomes embroiled in a vegetable revolution.</p> 
                            <div className="card-actions">
                    ...
                    <div className="card lg:card-side card-bordered border-neutral-900 my-4">                       
                        ...
                        <div className="card-body">
                            ...
                            <p className="text-lg my-2">Sienni befriends a carrot. Yaksha's disguise falters.  Natasha gets frightened.</p> 
                            <div className="card-actions">
                    ...
                    <div className="card lg:card-side card-bordered border-neutral-900 my-4">                       
                        ...
                        <div className="card-body">
                            ...
                            <p className="text-lg my-2">Sienni trusts the wrong spiders. Yaksha makes some new friends. Natasha goes quiet.</p> 
                            <div className="card-actions">
                    ...
                    <div className="card lg:card-side card-bordered border-neutral-900 my-4">                       
                        ...
                        <div className="card-body">
                            ...
                            <p className="text-lg my-2">Sienni breaks a code. Yaksha tries on some familiar faces. Boris comes to the rescue.</p> 
                            <div className="card-actions">
                    ...
                    <div className="card lg:card-side card-bordered border-neutral-900 my-4">                       
                        ...
                        <div className="card-body">
                            ...
                            <p className="text-lg my-2">Yaksha gets noticed. Boris shows his skills. Sienni has some crazy ideas.</p> 
                            <div className="card-actions">
                    ...
                    <div className="card lg:card-side card-bordered border-neutral-900 my-4">                       
                        ...
                        <div className="card-body">
                            ...
                            <p className="text-lg my-2">Yaksha explores a laboratory. Sienni and Natasha encounter Don Taraxa.</p> 
                            <div className="card-actions">
                    ...
                    <div className="card lg:card-side card-bordered border-neutral-900 my-4">                       
                        ...
                        <div className="card-body">
                            ...
                            <p className="text-lg my-2">The crew regroup on the Gilded Ghost to share what they've learned, but will it be enough to escape the thrall of The Village?</p> 
                            <div className="card-actions">
                    ...
                    <div className="card lg:card-side card-bordered border-neutral-900 my-4">                       
                        ...
                        <div className="card-body">
                            ...
                            <p className="text-lg my-2">An explosion rocks The Village, and it might've been the crew of the Gilded Ghost who caused it.</p> 
                            <div className="card-actions">
                    ...
                    <div className="card lg:card-side card-bordered border-neutral-900 my-4">                       
                        ...
                        <div className="card-body">
                            ...
                            <p className="text-lg my-2">A fight begins with the latest Number 2, but which is more deadly: his sword or his words?</p> 
                            <div className="card-actions">
                    ...
                    <div className="card lg:card-side card-bordered border-neutral-900 my-4">                       
                        ...
                        <div className="card-body">
                            ...
                            <p className="text-lg my-2">Fear threatens to consume a potential ally. Can the crew of the Gilded Ghost defeat their fears or will they fall prey themselves?</p> 
                            <div className="card-actions">
                    ...
                    <div className="card lg:card-side card-bordered border-neutral-900 my-4">                       
                        ...
                        <div className="card-body">
                            ...
                            <p className="text-lg my-2">To save No. 22 from the clutches of The Village, the crew of the Gilded Ghost risk falling prey to it themselves.</p> 
                            <div className="card-actions">
                    ...
                    <div className="card lg:card-side card-bordered border-neutral-900 my-4">                       
                        ...
                        <div className="card-body">
                            ...
                            <p className="text-lg my-2">Sienni meets Number One. Yaksha talks to the prisoner. Natasha rides a carousel.</p> 
                            <div className="card-actions">
                    ...
                    <div className="card lg:card-side card-bordered border-neutral-900 my-4">                       
                        ...
                        <div className="card-body">
                            ...
                            <p className="text-lg my-2">Natasha goes for a ride while Sienni and Yaksha plan a surprise.</p> 
                            <div className="card-actions">
                    ...
                    <div className="card lg:card-side card-bordered border-neutral-900 my-4">                       
                        ...
                        <div className="card-body">
                            ...
                            <p className="text-lg my-2">Yaksha makes a deal. Sienni asks some questions. Natasha sees an old friend.</p> 
                            <div className="card-actions">
